...
namespace ZocBuild.Database
{
    ...
    public class Database
    {
        ...
        public Database(string serverName, string databaseName, IDbConnection connection, IDbTransaction transaction, IScriptRepository scripts)
            : this(serverName, databaseName, connection, transaction, scripts, new EmptyLogger())
        {
        }
        ...
        public Database(string serverName, string databaseName, IDbConnection connection, IDbTransaction transaction, IScriptRepository scripts, ILogger logger)
        {
            ...
            if (scripts == null)
            {
                throw new ArgumentNullException("scripts", "The given script repository cannot be null");
            }
            if (logger == null)
            {
